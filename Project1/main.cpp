...
void InitMaterialsLight(int i)
{
    ...
    objects[i].materials.ambient_color = glm::vec3(0.2, 0.2, 0.1);
    objects[i].materials.diffuse_color = glm::vec3(0.5, 0.5, 0.3);
    objects[i].materials.specular_color = glm::vec3(1.0, 1.0, 1.0);
    objects[i].materials.power = 50.0;
}
